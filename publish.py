...
host = config['DAVIS']['host']
topic = config['DAVIS']['topic']
clientId = config['DAVIS']['client']
certPath = config['DAVIS']['certpath']
sensor_queue_path = config['DAVIS']['sensorqueue']
max_errors_exit = int(config['DAVIS']['max_errors_exit'])
